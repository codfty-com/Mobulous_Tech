...
const cases = [
  ...
  [stockRoutes, ["POST /stocks", "GET /stocks", "GET /stocks/summary", "GET /stocks/holdings", "GET /stocks/watchlist", "PATCH /stocks/prices", "GET /stocks/:id", "PUT /stocks/:id", "PATCH /stocks/:id", "PATCH /stocks/:id/watchlist", "PATCH /stocks/:id/alerts", "DELETE /stocks/:id"]],
